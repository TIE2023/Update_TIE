# Tech-It-Easy
# Sign to Text
# Data Collection part Should click the picture
# Make the sign for the alphabet/word in the frame and click on the corresponding letter
# The no. of times you press the letter that many images will be formed in the folder data
#Step 1 
import cv2
import numpy as np
import os
