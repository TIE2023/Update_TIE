...
class Application:
    def __init__(self):
        ...
        self.hs = Hunspell('en_CA')
        self.vs = cv2.VideoCapture(0)
        self.current_image = None
        self.current_image2 = None
        
        self.json_file = open("C:\\Users\\DELL\\Downloads\\Tech-It-Easy-main\\Tech-It-Easy-main\\model\\model-bw.json", "r")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights("C:\\Users\\DELL\\Downloads\\Tech-It-Easy-main\\Tech-It-Easy-main\\model\\model-bw.h5")

        self.json_file_dru = open("C:\\Users\\DELL\\Downloads\\Tech-It-Easy-main\\Tech-It-Easy-main\\model\\model-bw_dru.json" , "r")
        self.model_json_dru = self.json_file_dru.read()
        self.json_file_dru.close()
        self.loaded_model_dru = model_from_json(self.model_json_dru)
        self.loaded_model_dru.load_weights("C:\\Users\\DELL\\Downloads\\Tech-It-Easy-main\\Tech-It-Easy-main\\model\\model-bw_dru.h5")

        self.json_file_tkdi = open("C:\\Users\\DELL\\Downloads\\Tech-It-Easy-main\\Tech-It-Easy-main\\model\\model-bw_tkdi.json" , "r")
        self.model_json_tkdi = self.json_file_tkdi.read()
        self.json_file_tkdi.close()
        self.loaded_model_tkdi = model_from_json(self.model_json_tkdi)
        self.loaded_model_tkdi.load_weights("C:\\Users\\DELL\\Downloads\\Tech-It-Easy-main\\Tech-It-Easy-main\\model\\model-bw_tkdi.h5")

        self.json_file_smn = open("C:\\Users\\DELL\\Downloads\\Tech-It-Easy-main\\Tech-It-Easy-main\\model\\model-bw_smn.json" , "r")
        self.model_json_smn = self.json_file_smn.read()
        self.json_file_smn.close()
        self.loaded_model_smn = model_from_json(self.model_json_smn)
        self.loaded_model_smn.load_weights("C:\\Users\\DELL\\Downloads\\Tech-It-Easy-main\\Tech-It-Easy-main\\model\\model-bw_smn.h5")
    ...
    def action_call(self) :      
        ...
        self.photo1 = tk.PhotoImage(file='TIE2.png')
        self.w1 = tk.Label(self.root1, image = self.photo1)
        self.w1.place(x = 20, y = 250)
